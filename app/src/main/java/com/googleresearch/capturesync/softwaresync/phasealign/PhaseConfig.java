...
public final class PhaseConfig {
    ...
    private final long matchThresholdNs;
    private final long streamingPeriodFrames;
    private final long overheadNs;
    private final long minExposureNs;

    private PhaseConfig(
            long periodNs, long goalPhaseNs, long alignThresholdNs,
            long overheadNs, long minExposureNs, long matchThresholdNs, long streamingPeriodFrames) {
        this.periodNs = periodNs;
        this.goalPhaseNs = goalPhaseNs;
        this.alignThresholdNs = alignThresholdNs;
        this.overheadNs = overheadNs;
        this.matchThresholdNs = matchThresholdNs;
        this.streamingPeriodFrames = streamingPeriodFrames;
    ...
    public static PhaseConfig parseFromJSON(JSONObject json) throws JSONException {
        ...
        return new PhaseConfig(
                ...
                json.getLong("matchThresholdNs"),
                json.getLong("streamingPeriodFrames")
        );
    }
    ...
    public long matchThresholdNs() {
        return matchThresholdNs;
    }

    public long streamingPeriodFrames() {
        return streamingPeriodFrames;
    }
